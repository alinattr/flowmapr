...
import { Lock, Copy, Check, RotateCcw, FileDown } from 'lucide-react'
    ...
    try {
      ...
      if (res.status === 402) {
        ...
        if (data.code === 'PLAN_REQUIRED') {
          toast.error('Explain Diagram requires Basic or Pro plan.')
        } else {
    ...
    try {
      ...
      container.innerHTML = `
        <div style="border-bottom:2px solid #6366F1;padding-bottom:20px;margin-bottom:36px;">
          ...
          <div style="font-size:22px;font-weight:700;color:#111827;margin-bottom:6px;">${escapeHtml(result.fileName)}</div>
      ...
      const safeName = result.fileName.replace(/\.[^.]+$/, '').replace(/[^a-z0-9]/gi, '-')
              ...
              <div style={{
                ...
                <div>
                  ...
                  <div style={{ fontSize: 12, color: T.planGateDesc, fontFamily: 'Inter, sans-serif', marginTop: 2 }}>
                    Explain Diagram consumes 1 generation credit per analysis.{' '}
              ...
              {!file ? (
                <div
                  ...
                  style={{
                    ...
                    gap: 8, cursor: isLocked ? 'not-allowed' : 'pointer',
